...
function getMarkers(callback) {
  ...
  console.log("now in getMarkers");
    ...
    // console.log("using test data"); // limited test version
...
function loadMarker(markerData, dfd) {
  ...
  var kmlFile = "assets/kml/" + markerData.slug + ".kml";
  var imageFile = "essays/" + markerData.slug  + "/images/" + markerData.imageFile;
  var outline = {};
